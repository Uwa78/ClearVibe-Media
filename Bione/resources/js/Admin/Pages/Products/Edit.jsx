...
export default function Edit({ languages, product_categories, default_lang, product }) {
        ...
        <AdminLayouts>
            ...
            <div className="container-fluid">
                <div className="yoo-uikits-heading">
                    <h2 className="yoo-uikits-title">{translate("Edit Product")}</h2>
                </div>
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <div className="form-group form-group-md">
                                                <div className="yoo-select">
                                                    ...
                                                    <FormValidationError message={errors.category_id} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
