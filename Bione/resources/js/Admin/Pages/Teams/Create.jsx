...
import { updateCurrentEditedSection, updateCurrentLang, updatePageData, updatePageInfo } from "@/Redux/features/pages/Page/page"
...
import TeamDetails from "@/Admin/Components/SectionCustomize/TeamDetails"
...
export default function Create() {
    ...
    const [expandCustomize, setExpandCustomize] = useState("TeamDetailsPage")
    ...
    const handlePublish = () => {
        ...
        if (!errors) {
            router.post(route("admin.teams.store"), {
                pageData,
                pageInfo,
                customizeSections
            })
    ...
    return (
        <PageCustomizeLayout type="team">
            <Head title="Create team" />
            <div className="customize-header-actions">
                <Link href={route("admin.teams.index")} className="dismiss">
                ...
                <div className="customize-section-area">
                    <div className="page-customize-notice">
                        ...
                        <div className={`page-customize-notice-content ${isExpandInfo ? "show" : ""}`}>
                            <p>
                                The Customizer allows you to preview changes to your site before publishing them. You can navigate to different pages
                                on your site within the preview. Edit shortcuts are shown for some editable elements. The Customizer is intended for
                                use with non-block themes.
                            </p>
                        </div>
                    </div>
                    <div className="customize-sections">
                        <div className="customize-sections-item" onClick={() => handleExpand("TeamDetailsPage")}>
