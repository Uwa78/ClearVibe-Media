...
import CaseStudyDetails from "@/Admin/Components/SectionCustomize/CaseStudyDetails"
...
export default function Create() {
    ...
    const [expandCustomize, setExpandCustomize] = useState("CaseStudyPageDetails")
    ...
    const handlePublish = () => {
        ...
        if (!errors) {
            router.post(route("admin.case.study.store"), {
                pageData,
                pageInfo,
                customizeSections
            })
    ...
    return (
        <PageCustomizeLayout type="case_study">
            ...
            <div className="customize-header-actions">
                <Link href={route("admin.case.study.index")} className="dismiss">
            ...
            <div className="customize-section-wrap">
                ...
                <div className="customize-section-area">
                    ...
                    <div className="customize-sections">
                        <div className="customize-sections-item" onClick={() => handleExpand("CaseStudyPageDetails")}>
                            <div className="customize-sections-item-title">
                                <h3>Case Study Page Details</h3>
                            </div>
